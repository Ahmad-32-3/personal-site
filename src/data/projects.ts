    ...
    items: [
      {
        ...
        d: "A routing proxy that sends easy chatbot questions to a cheap model and repeats to a cache, so you stop paying for the most expensive model on work it does not need. You can try the routing live on the page.",
        claim: "Stop paying top-model prices for easy questions.",
        method:
          "A FastAPI proxy: length and keyword policy picks a lane, an exact-hash cache skips repeats, OpenRouter runs the call. Scored as cost per successful task under a quality floor.",
        feat: 1,
      },
      {
        t: "EchoAsk",
    ...
    items: [
      {
        ...
        d: "Overnight EEG from children with epilepsy: flag a seizure while it is on the tracing, on a patient the model never saw. Catch rate, false pages per hour, and delay after EEG onset, leave-one-patient-out.",
      },
      {
        t: "WattAhead",
        tag: "Time series",
